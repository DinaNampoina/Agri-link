            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('annonces.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select id="produit_id" name="produit_id" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" onchange="document.getElementById('nouveau_produit_wrapper').style.display = this.value === 'autre' ? 'block' : 'none'">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="description" name="description" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" rows="3">{{ old('description') }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="quantite" class="block mt-1 w-full" type="number" step="0.1" name="quantite" :value="old('quantite')" required min="0.1" />
                    ...
                    <div class="mt-4">
                        ...
                        <select id="unite" name="unite" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" onchange="document.getElementById('nouvelle_unite_wrapper').style.display = this.value === 'autre' ? 'block' : 'none'">
                            ...
                            <option value="unité" {{ old('unite') == 'unité' ? 'selected' : '' }}>À l'unité (pièce)</option>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="prix" class="block mt-1 w-full" type="number" name="prix" :value="old('prix')" required min="0" step="1" />
                    ...
                    <div class="mt-4">
                        ...
                        <select id="region" name="region" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" onchange="document.getElementById('nouvelle_region_wrapper').style.display = this.value === 'autre' ? 'block' : 'none'">
                            <option value="">-- Choisir --</option>
                            <option value="Antsirabe I" {{ old('region') == 'Antsirabe I' ? 'selected' : '' }}>Antsirabe I</option>
                            <option value="Antsirabe II" {{ old('region') == 'Antsirabe II' ? 'selected' : '' }}>Antsirabe II</option>
                            <option value="Betafo" {{ old('region') == 'Betafo' ? 'selected' : '' }}>Betafo</option>
                            <option value="Faratsiho" {{ old('region') == 'Faratsiho' ? 'selected' : '' }}>Faratsiho</option>
                            <option value="Andramasina" {{ old('region') == 'Andramasina' ? 'selected' : '' }}>Andramasina</option>
                            <option value="Manjakandriana" {{ old('region') == 'Manjakandriana' ? 'selected' : '' }}>Manjakandriana</option>
                    ...
                    <div class="mt-4">
                        ...
                        <input id="chemin_image" type="file" name="chemin_image" class="block mt-1 w-full" required accept="image/*" onchange="const p=document.getElementById('preview'); const f=this.files[0]; if(f){p.src=URL.createObjectURL(f); p.classList.remove('hidden');}">
